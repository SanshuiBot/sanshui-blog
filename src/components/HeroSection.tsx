  ...
  return (
    ...
    >
      ...
      <MorphBlob
        ...
        size={500}
        duration={20}
        className="absolute top-[5%] left-[2%] pointer-events-none"
      />
      <MorphBlob
      ...
      <MorphBlob
        ...
        size={350}
        duration={18}
        className="absolute top-[55%] left-[60%] pointer-events-none"
      />

      {/* Sparkles */}
      <Sparkles count={12} className="pointer-events-none" shapes={['dot', 'star']} />

      {/* Floating gradient orbs */}
      <div className="absolute top-[-10%] right-[-5%] w-[42rem] h-[42rem] rounded-full blur-[120px] opacity-50 dark:opacity-25 pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(220,38,38,0.25), rgba(234,88,12,0.12) 40%, transparent 70%)' }}
      />
      <div className="absolute bottom-[-15%] left-[-10%] w-[36rem] h-[36rem] rounded-full blur-[100px] opacity-40 dark:opacity-20 pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(251,191,36,0.2), rgba(254,215,170,0.08) 50%, transparent 75%)' }}
      />
      ...
      >
        <div className="max-w-3xl">
          {/* Status badge — animated presence dot */}
          <motion.div
          ...
          >
            ...
            <span className="block mt-2">
              <GradientText mode="holo" size="xl" glow>
                三水
              </GradientText>
            </span>
          </motion.h1>
