    ...
    <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
      ...
      <ScrollReveal direction="up" delay={0.1}>
        <div className="relative mb-12">
          ...
          >
            你好，我是 <GradientText mode="holo">三水</GradientText> 👋
          </h1>
        </div>
      </ScrollReveal>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {stack.map((s, i) => (
              <div
                key={s.title}
                className="group/stack relative p-5 rounded-2xl bg-white/80 dark:bg-stone-900/80 backdrop-blur border border-stone-200/60 dark:border-stone-800/60 hover:shadow-holographic transition-all duration-700 ease-[var(--ease-out-quint)] shimmer-surface overflow-hidden animate-fade-up"
      ...
      <ScrollReveal direction="up" delay={0.35}>
        <div className="mt-16 p-8 rounded-3xl border border-stone-200/60 dark:border-stone-800/60 relative overflow-hidden aurora shimmer-surface">
          <MorphBlob
          ...
          <div className="flex flex-wrap gap-3 relative">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-stone-900 dark:bg-stone-50 text-white dark:text-stone-900 text-sm font-medium hover:scale-105 active:scale-95 transition-transform light-ray ripple"
            >
              <Code2 size={16} />
              GitHub
            </a>
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white dark:bg-stone-900 text-stone-700 dark:text-stone-300 text-sm font-medium border border-stone-200 dark:border-stone-800 hover:scale-105 active:scale-95 transition-transform light-ray ripple"
            >
              <Mail size={16} />
              Email
            </a>
