...
export default async function TagPage({ params }: { params: Promise<{ tag: string }> }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-24">
      <PageHeader title={decoded} description={`共 ${posts.length} 篇文章`} backHref="/tags" backLabel="所有标签">
        <div className="flex items-center gap-3 mt-3"><Hash size={24} className="text-pink-500" /></div>
      </PageHeader>
