        ...
        <div className="space-y-4">
          {links.map((link, i) => (
            <motion.a
              ...
              className="group/link relative flex items-center gap-5 p-6 rounded-2xl bg-white/80 dark:bg-stone-900/80 backdrop-blur border border-stone-200/60 dark:border-stone-800/60 hover:border-transparent transition-all duration-700 ease-[var(--ease-out-quint)] hover:shadow-iridescent prism-border"
            >
              <div
                aria-hidden="true"
                ...
                style={{
                  background: 'radial-gradient(300px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(244,114,182,0.1), rgba(192,132,252,0.08), transparent 65%)',
                }}
              />
              ...
              <div className="w-14 h-14 rounded-2xl overflow-hidden flex-shrink-0 bg-stone-100 dark:bg-stone-800 ring-2 ring-stone-200/50 dark:ring-stone-700/50 group-hover/link:ring-transparent transition-all duration-500">
                <Image
                  ...
                  onError={(e) => {
                    ...
                    target.src = 'data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 48 48%22><rect fill=%22%23e7e5e4%22 width=%2248%22 height=%2248%22/><text x=%2224%22 y=%2230%22 text-anchor=%22middle%22 font-size=%2220%22 fill=%22%23a8a29e%22>G</text></svg>';
                  }}
                />
              </div>
