...
export default function Home() {
  ...
  return (
    <>
        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              { value: '∞', label: '想法', suffix: '' },
              { value: '1', label: '作者', suffix: '' },
              { value: '24/7', label: '在线', suffix: '' },
            ].map((stat) => (
              <div
                key={stat.label}
                className="group/stat relative p-5 sm:p-6 rounded-2xl bg-white/60 dark:bg-stone-900/60 backdrop-blur border border-stone-200/50 dark:border-stone-800/50 hover:border-transparent transition-all duration-700 ease-[var(--ease-out-quint)] hover:shadow-iridescent"
              >
      ...
      {/* Featured Post — double-bezel aesthetic */}
      {featuredPost && (
